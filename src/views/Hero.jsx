...
function Hero() {
  return (
    <div
      ...
      id="home"
    >
      <BackgroundBeamsWithCollision className="absolute top-3 left-0 -z-10 w-full h-[100vh]" />
      <section className="w-full h-[100vh] flex flex-col justify-center items-center gap-5 px-4">
        ...
        <div className="section-2 flex flex-col justify-center items-center gap-5 mb-4">
          <motion.h1
            initial={{ y: 100, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
        ...
        >
          ...
          >
            <a
              ...
              className="flex items-center gap-2 text-xl bg-gradient-to-r from-blue-500 to-purple-500 text-white px-10 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
            >
              My Resume
