    ...
    >
      ...
      >
        ...
        <div className="relative z-10 w-full flex items-center justify-start">
          <div className="relative w-full h-full flex items-center justify-center font-bold text-2xl">
            <div className="absolute w-full h-full bg-transparent blur-sm" />
            <span className="font-ovo z-20">{text}</span>
          </div>
        </div>
      </div>
    </div>
